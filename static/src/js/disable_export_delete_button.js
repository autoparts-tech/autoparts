    ...
    ListController.include({
        ...
        renderSidebar: function ($node) {
            if (this.hasSidebar && !this.sidebar) {
            	...
            	this.getSession().user_has_group('master.group_export_button').then(function(has_group) {
                    if(has_group) {
            	...
            	this.getSession().user_has_group('master.group_delete_button').then(function(has_group) {
                    if(has_group) {
